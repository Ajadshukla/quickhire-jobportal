  ...
  return (
    <div className="qh-page min-h-screen">
      ...
      <div className="qh-shell py-6">
        <div className="qh-panel max-w-5xl mx-auto">
          <div className="flex items-center justify-between gap-2 flex-wrap">
            <h1 className="qh-title">Resume Analyzer</h1>
            <Badge className="bg-slate-900 text-white">Student Feature</Badge>
          </div>
          ...
          <div className="mt-4 flex flex-col md:flex-row gap-2">
            <select
              ...
              className="border border-gray-300 rounded-md px-3 py-2 w-full bg-white dark:bg-slate-900"
            >
          ...
          {!hasResume(user) && (
            <div className="mt-3 rounded-md border border-rose-200 bg-rose-50 px-3 py-2 text-sm text-rose-700">
              Upload a PDF resume first from your
              <Link to="/Profile" className="font-semibold underline ml-1">
                profile page
              </Link>
              .
            </div>
          ...
          {analysis && (
            <div className="mt-5 border border-gray-200 rounded-md p-3 bg-white dark:bg-slate-900">
              ...
              <div className="rounded-md border border-slate-200 p-3 bg-slate-50 mb-3">
                ...
                <div className="h-2 w-full rounded bg-slate-200 overflow-hidden mb-2">
                  <div className="h-full bg-emerald-500" style={{ width: `${matchedRatio}%` }} />
                </div>
                ...
                <div className="h-2 w-full rounded bg-slate-200 overflow-hidden">
                  <div className="h-full bg-blue-500" style={{ width: `${sectionHealth}%` }} />
                </div>
              </div>
              ...
              <div className="rounded-md border border-slate-200 overflow-hidden mb-3">
                ...
                {sectionEntries.map(([key, value]) => (
                  <div key={key} className="grid grid-cols-12 px-3 py-2 text-sm border-t border-slate-100">
